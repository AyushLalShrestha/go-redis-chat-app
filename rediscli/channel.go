...
// getChannelUUID gets a UUID for communication between sender & receiver.
...
// ChannelJoin creates a redis pubsub channel for communication between the sender & receiver.
// Returns a redis pubsub subscribable channel.
...
// ChannelMessage appends the message to redis channel

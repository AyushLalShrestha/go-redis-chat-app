...
// channelSessionsAdd adds the sessionUUID/userUUID to the channelSessionsJoins
...
// channelSessionsSendMessage sends message to all the participants connected
// to the redis chat channel with UUID channelUUID

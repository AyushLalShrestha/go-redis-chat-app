...
// ChannelJoin connects the sessionUUID to the channel in redis to connect to the receiver.
// It also fetches messages in the channel & sends it to the websocket conn.
